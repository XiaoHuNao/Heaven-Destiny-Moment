...
public record ClientMoonSettingsContext(int moonColor, float MoonSize, ResourceLocation MoonTexture) {
    public static final ClientMoonSettingsContext EMPTY = new ClientMoonSettingsContext(-1, 20, new ResourceLocation("textures/environment/moon_phases.png"));
    public static final Codec<ClientMoonSettingsContext> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            ...
            ResourceLocation.CODEC.optionalFieldOf("moon_texture",new ResourceLocation("textures/environment/moon_phases.png")).forGetter(ClientMoonSettingsContext::MoonTexture)
