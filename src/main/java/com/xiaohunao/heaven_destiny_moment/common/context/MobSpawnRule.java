...
public record MobSpawnRule(Optional<Boolean> allowOriginalBiomeSpawnSettings, Optional<Boolean> forceSurfaceSpawning,
                           Optional<Boolean> slimesSpawnEverywhere, Optional<Boolean> ignoreLightLevel) {
    ...
    public static class Builder {
        ...
        public MobSpawnRule build() {
            return new MobSpawnRule(Optional.ofNullable(allowOriginalBiomeSpawnSettings), Optional.ofNullable(forceSurfaceSpawning), Optional.ofNullable(slimesSpawnEverywhere), Optional.ofNullable(ignoreLightLevel));
        }
    }
}
